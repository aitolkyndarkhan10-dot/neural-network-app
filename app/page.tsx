      ...
      <section className="grid items-center gap-6 lg:grid-cols-[1.05fr_0.95fr]">
        <div className="space-y-5">
          ...
          <h1 className="text-4xl font-black tracking-tight text-slate-900 md:text-5xl">
            Нейрондық желілерді оқытуға арналған интерактивті зертхана
          </h1>

          <p className="text-lg leading-8 text-slate-700">
            Бұл платформада нейрондық желілер тек теориялық тұрғыда емес,
            интерактивті тәжірибелер арқылы түсіндіріледі. Пайдаланушы
            нейрондардың өзара байланысын, деректердің өңделу кезеңдерін,
            салмақтар мен белсендіру функцияларының нәтижеге әсерін және
            модельдің шешім қабылдау механизмін көрнекі түрде бақылай алады.
          </p>

          <p className="mt-4 max-w-4xl text-base leading-8 text-slate-600 md:text-lg">
            Платформада нейрондық желілердің жұмысын зерттеуге арналған
            симуляторлар, цифрларды тану, суреттерді өңдеу, дыбысты мәтінге
            түрлендіру, эмоцияларды анықтау, AI арқылы сурет генерациясы мен
            видео генерациясын түсіндіретін оқу құралдары ұсынылған.
          </p>
